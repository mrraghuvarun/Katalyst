...
const BackReporting = () => {
    ...
    const handleConfirmUpload = async () => {
        ...
        try {
            ...
            await emailjs.send("service_wwbo9w7", "template_c7yghon", emailParams, "zcZkGQ35dZ0552hi-");
    ...
    return (<Layout collapsed={collapsed}>
      {loading ? ( // Show loading page if loading state is true
        <Loading />) : (<div className="back-reporting-container">
        ...
        {currentStep === 2 && (<div className="step-content">
            <h3>Data Preview</h3>
              <div className="field">
                <label>
                  Database Name:
            ...
            <div className="pagination-controls">
              <label>
                ...
                <select value={rowsPerPage} onChange={handleRowsPerPageChange}>
                  {[10, 25, 50, 100, 200].map((pageSize) => (<option key={pageSize} value={pageSize}>
                      {pageSize}
                    </option>))}
                </select>
              </label>
            ...
            <table>
              ...
              <tbody>
                {paginatedData.map((row, rowIndex) => (<tr key={rowIndex}>
        ...
        {currentStep === 3 && (<div className="step-content">
        ...
        <div className="navigation-buttons">
          <button onClick={handlePreviousStep} disabled={currentStep === 1} className="previous-button">
            Previous
          </button>
        ...
        <Modal isOpen={isHistoryModalOpen} onClose={toggleHistoryModal} data={uploadHistory} title="Upload History"/>
      </div>)}
    </Layout>);
};
